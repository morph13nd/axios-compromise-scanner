...
**For fully updated incident context, detection playbook, and containment checklist, see the [CyberReplay axios npm compromise write-up](https://cyberreplay.com/blog/axios-compromised-on-npm-malicious-releases-remote-access-trojan/).**
